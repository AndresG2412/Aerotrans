...
export default function Contacto() {
    return(
        <div className="relative w-full mt-40 mb-36 h-[650px] bg-cover flex" style={{ backgroundImage: `url(${b_c.src})` }} >
            <div className="w-1/2 h-[450px] my-auto ml-32 text-center flex flex-col justify-center">
                ...
                <br />
                <Button titulo={"WhatsApp"} color={"green"}></Button>
            </div>
            <div className="w-1/2 h-[450px] my-auto mr-32 flex flex-col justify-center">
                ...
                <Button titulo={"Enviar"} color={"red"}></Button>
                </div>
        </div>
    );
}